...
def get_corona_detail_of_india():
    ...
    #Website from where the data is parsed
...
def get_corona_detail_of_states():
    ...
    f_data=open(r"Path along with name of the csv file here",'w')
...
def refresh():
    plyer.notification.notify(
            ...
            timeout=10,
            app_icon=r'Path of the app icon image')
...
root.iconbitmap(r"Path of the app icon image")
root.title("CORONA DATA TRACKER - INDIA")
root.configure(background='light blue')
f = ("poppins", 14, "bold")
banner = tk.PhotoImage(file=r"Path of the banner image")
